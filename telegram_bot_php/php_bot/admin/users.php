...
<div class="card panel">
  <div class="table-wrap">
    <table>
      <thead>
        <tr><th>ID</th><th>Telegram</th><th>Name</th><th>Contact</th><th>Phone</th><th>Username</th><th>Warns</th><th>Joined</th></tr>
      </thead>
      <tbody>
      ...
      <?php endforeach; ?>
      <?php if (!$rows): ?><tr><td colspan="8" class="muted">No users yet. Ask someone to /start the bot.</td></tr><?php endif; ?>
      </tbody>
    </table>
  </div>
</div>
