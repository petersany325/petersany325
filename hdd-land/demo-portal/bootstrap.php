...
function demo_roles(): array
{
    return [
        'customer' => [
            ...
            'letter' => 'م',
            'title' => 'ورود مشتری',
            'lead' => 'وب‌سرویس اختصاصی کارتابل مشتری — موبایل و تأیید پیامک، پیگیری قبض و پرداخت',
            'css' => 'customer',
        ],
        'staff' => [
            'key' => 'staff',
            'letter' => 'ک',
            'title' => 'ورود کارمندان',
            'lead' => 'وب‌سرویس موبایل و پنل کامپیوتر — منوها خودکار با تشخیص دستگاه تنظیم می‌شوند',
            'css' => 'staff',
        ],
        'trainee' => [
            'key' => 'trainee',
            'letter' => 'آ',
            'title' => 'ورود کارآموز',
            'lead' => 'پرتال کارآموز — دفتر روز و خدمات تعریف‌شده شرکت (با دسترسی مدیر)',
            'css' => 'intern',
        ],
    ];
}
...
// --- views (bundled so one-file pull works) ---
