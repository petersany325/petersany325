  ...
  <form method="post" action="{{ url('/admin/web-app') }}">@csrf
    ...
    <div class="vb-block">
      ...
      <div class="vb-block-body">
        ...
        <div class="vb-opt"><div><span class="vb-title">عنوان منو</span></div><div class="vb-ctrl"><input type="text" name="drawer_title" value="{{ $f('drawer_title','منوی سرزمین هارد') }}"></div></div>
        <div class="vb-opt"><div><span class="vb-title">زیرعنوان</span></div><div class="vb-ctrl"><input type="text" name="drawer_subtitle" value="{{ $f('drawer_subtitle','فروشگاه و تأمین سازمانی') }}"></div></div>
