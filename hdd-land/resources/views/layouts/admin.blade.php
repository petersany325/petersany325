  ...
  $groups = [
    ...
    'accounting' => [
      ...
      'items' => [
        ...
        ['label' => 'چک‌ها', 'href' => $u('accounting/checks'), 'active' => $is('accounting/checks'), 'perm' => 'accounting.checks'],
        ...
        ['label' => 'کمیسیون فروش', 'href' => $u('accounting/commissions'), 'active' => $is('accounting/commissions'), 'perm' => 'accounting.payroll'],
