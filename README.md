...
### ۳) نمونه سایت شهر بازی / آکادمی بازی (`shahr-bazi-demo/`)
- UI تست فارسی برای منو، رزرو بلیت، تولد، کلاس، عضویت و رضایت‌نامه
- اجرای محلی: `cd shahr-bazi-demo && python3 -m http.server 4173`
