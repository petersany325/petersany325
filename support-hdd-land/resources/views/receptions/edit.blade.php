...
<form method="POST" action="{{ route('receptions.update', $r) }}" enctype="multipart/form-data" class="accept-form">
    ...
    <div class="panel" style="margin-bottom:10px;">
        ...
        <p class="muted" style="margin:0 0 8px;font-size:11.5px;">
            اگر این مشتری قبض‌های دیگری داشته باشد، <strong>تغییر نام او از این صفحه روی آن قبض‌ها اعمال نمی‌شود</strong>
            (از قاطی‌شدن هویت مشتری‌ها جلوگیری می‌شود). برای تغییر پرونده مشتری از منوی مشتریان استفاده کنید.
            اگر موبایل متعلق به مشتری دیگری باشد، این قبض به همان مشتری منتقل می‌شود.
        </p>
