...
<div class="panel" style="max-width:720px;">
    <div style="display:flex;justify-content:space-between;gap:10px;flex-wrap:wrap;align-items:center;">
        <div>
            ...
            <p class="lead" style="margin:4px 0 0;">فعال‌سازی پورتال، قوانین عکس و تلفن دفتر.</p>
        </div>
    ...
    <form method="POST" action="{{ route('remote-preorders.settings.save') }}" style="margin-top:14px;display:grid;gap:10px;">
        ...
        <label>تلفن دفتر (نمایش در کارتابل و پیامک)
            <input type="text" name="office_phone" value="{{ old('office_phone', $settings['office_phone']) }}" required dir="ltr" style="text-align:left;" placeholder="01144447220">
        </label>
