            ...
            <form method="POST" action="{{ route('settings.general') }}" class="panel">
                ...
                <div class="accept-row accept-row-2" style="margin-top:10px;">
                    <div>
                        ...
                        <input type="text" name="receipt_prefix" value="{{ old('receipt_prefix', $receiptPrefix ?? 'R') }}" maxlength="12" dir="ltr" style="text-align:left;" placeholder="مثلاً T-20N یا R" pattern="[A-Za-z0-9\-]*">
                        <p class="muted" style="margin:4px 0 0;font-size:11px;">فقط حروف انگلیسی، عدد و خط تیره. هر تعمیرگاه پیشوند خودش را دارد؛ پیش‌فرض نصب‌های جدید: R</p>
                    </div>
                    <div>
                        <label>نمونه قبض بعدی</label>
                        <input type="text" value="{{ $receiptPrefixSample ?? (($receiptPrefix ?? 'R').'1000') }}" readonly dir="ltr" style="text-align:left;">
                        <p class="muted" style="margin:4px 0 0;font-size:11px;">شماره واقعی از آخرین قبض همین پیشوند ادامه می‌یابد.</p>
                    </div>
                </div>
                ...
                <div class="actions" style="margin-top:10px;">
                    <button class="btn btn-primary" type="submit">ذخیره تنظیمات عمومی</button>
                </div>
            </form>
        </div>
