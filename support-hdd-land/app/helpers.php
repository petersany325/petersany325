...
if (! function_exists('format_app_time')) {
    /** Display time H:i with optional Persian digits from calendar setting. */
    function format_app_time($date): string
    {
        if ($date instanceof \Illuminate\Support\Optional || blank($date)) {
            return '—';
        }
...
if (! function_exists('jalali_input')) {
     ...
     * Always ASCII digits (input-friendly): Jalali 1404/05/16.
     */
