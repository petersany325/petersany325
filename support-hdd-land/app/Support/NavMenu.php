        ...
        $groups = [
            ...
            [
                ...
                'children' => [
                    ...
                    ['label' => 'ارسال لینک کارتابل', 'route' => 'portal-invites.index', 'match' => 'portal-invites.*', 'hint' => 'تکی + گروهی + گزارش', 'mark' => 'ل'],
            ...
            [
                ...
                'children' => [
                    ...
                    ['label' => 'اقساط', 'route' => 'installments.index', 'match' => 'installments.*', 'hint' => 'طرح و دریافت قسط', 'mark' => 'ق', 'permission' => 'reports.accounting'],
                    ['label' => 'گزارش اقساط', 'route' => 'installments.report', 'match' => 'installments.report', 'hint' => 'پرداخت‌شده / معوق', 'mark' => 'گ', 'permission' => 'reports.accounting'],
                    ['label' => 'پیامک اقساط', 'route' => 'installments.settings', 'match' => 'installments.settings', 'hint' => 'یادآوری سررسید', 'mark' => 'پ', 'permission' => 'reports.accounting'],
