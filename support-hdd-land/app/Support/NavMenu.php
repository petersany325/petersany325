    ...
    public static function forUser(User $user): array
    {
        ...
        $groups = [
            ...
            [
                ...
                'mark' => 'ا',
                'hint' => 'دریافت دستگاه، ارجاع نماینده، هاردهای دست تعمیر',
                ...
                'children' => [
                    ...
                    ['label' => 'کارتابل ارجاع نماینده', 'route' => 'partners.cartable', 'match' => 'partners.cartable|partners.intake*', 'hint' => 'قبض همکار؛ طرف حساب نماینده', 'mark' => 'نم', 'permission' => 'partners'],
            ...
            [
                ...
                'match' => 'partners.index|partners.create|partners.edit|partners.store|partners.update',
                'mark' => 'ه',
                'hint' => 'همکاران تعمیرگاهی طرف حساب ارجاع',
                'children' => [
                    ['label' => 'فهرست نمایندگان', 'route' => 'partners.index', 'match' => 'partners.index|partners.edit', 'hint' => 'ثبت و ویرایش همکار', 'mark' => 'ف'],
                    ['label' => 'نماینده جدید', 'route' => 'partners.create', 'match' => 'partners.create', 'hint' => 'افزودن همکار', 'mark' => '+'],
                    ['label' => 'پذیرش از نماینده', 'route' => 'partners.intake', 'match' => 'partners.intake*', 'hint' => 'قبض جدید به نام نماینده', 'mark' => 'پ'],
                ],
            ],
            [
                'key' => 'notifications',
