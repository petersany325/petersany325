...
Route::get('/login/sms', [AuthController::class, 'showSmsLogin'])->name('login.sms');
...
Route::middleware('guest')->group(function () {
    ...
    Route::post('/login/sms/send', [AuthController::class, 'sendSmsLogin'])->name('login.sms.send');
    Route::post('/login/sms/verify', [AuthController::class, 'verifySmsLogin'])->name('login.sms.verify');
