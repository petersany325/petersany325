...
@if($staff && !empty($staff->referral_code))
  <div class="panel" style="padding:.75rem .85rem;margin-bottom:.75rem;background:#f3fbf7;border:1px solid #b7e4cd">
    <div class="row" style="justify-content:space-between;gap:1rem;flex-wrap:wrap;align-items:flex-start">
      <div>
        <h3 style="margin:0 0 .35rem;font-size:.95rem">کد معرف شما</h3>
      ...
      <div style="text-align:left" dir="ltr">
        <div style="font-size:1.15rem;font-weight:800;letter-spacing:.08em;color:#047857">{{ $staff->referral_code }}</div>
...
<div class="panel" style="padding:.75rem .85rem;margin-bottom:.75rem;border:1px solid #c5d8ef;background:#f7faff">
