...
final class ChatModes
{
    ...
    public static function rules(string $mode, Settings $settings): string
    {
        ...
        return match ($mode) {
            ...
            self::VIP =>
                "⭐ <b>قوانین کلاب استار</b>\n\n" .
                "این چت اختصاصی برای اعضای تأییدشدهٔ <b>استار کلاب</b> است (آشنایی جدی و رابطه سالم).\n\n" .
                "✅ لحن مودب و سطح‌بالا — توهین و بی‌احترامی ممنوع.\n" .
                "✅ مشخصات و شهر باید واقعی باشد (موقعیت GPS فقط برای اعضای استار و مخفی از بقیه).\n" .
            ...
            default =>
                ...
                "🚫 درخواست رابطه، سکس، برنامه، پول، فحش یا پارتنر (فارسی/فینگلیش) اینجا مجاز نیست — برای این‌ها برو <b>کلاب هات</b>.\n\n" .
                "با ورود، این قوانین را می‌پذیری.",
        };
    }
}
